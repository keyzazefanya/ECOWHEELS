...
public class ManualBicyclePage extends JFrame {
    public ManualBicyclePage(String location) {
        setTitle("Manual Bicycle");
        setSize(800, 600);
        ...
        try {
            ...
            String sql = "SELECT model, available, image_url FROM Bicycles WHERE type='Manual' AND location_area=?";
